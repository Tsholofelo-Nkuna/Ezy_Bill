...
namespace Core.Presentation.ViewComponents.Components.Pages.Invoices
{
    public partial class DetailsPage : GenericComponentBase<InvoiceDetailsViewModel, InvoiceDto>
    {
