...
namespace Core.Presentation.ViewComponents.Components.Pages.Clients
{
    public partial class DetailsPage : GenericComponentBase<ClientDetailsViewModel, ClientDto>
    {
        [Parameter]
